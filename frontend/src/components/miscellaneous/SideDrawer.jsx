...
import { Drawer, DrawerContent, DrawerHeader, DrawerOverlay,Box, Center,Text,Stack, HStack, VStack, Tooltip } from "@chakra-ui/react"
...
const LeftPanel = () => {
    ...
    return (
        <Box w={{base:"19%",sm:"13%", md:"5%" }} p={4} h='100%' color={'black'} bg="white" border='0px'  borderTopRightRadius={"25"} borderBottomRightRadius={"25"} boxShadow='dark-lg'>
            <Box d="flex"  mt={70} >
                <Center>
